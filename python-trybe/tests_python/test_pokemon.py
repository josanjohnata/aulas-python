...
# e substituir o método open em tempo de execução por um objeto mock_open, que
# já vem embutido na linguagem e se comporta como o open , retornando o que
# foi definido em read_data como seu conteúdo. Um detalhe interessante é que
# esse objeto obtido através da função mock_open também possui a capacidade de
# armazenar informações sobre como foram as chamadas de seus métodos e os
...
#         "speed": 43,
#     }
#     pokemon_json_content = json.dumps({"results": [grass_type_pokemon,
# water_type_pokemon]})
...
#         # o argumento "dummy" poderia ser substituído por qualquer coisa, já
