...
# Exercício 2: Em um jogo de baralho, as cartas estão representadas por um
# array numérico. Para iniciar o jogo devemos embaralhar as cartas. Faremos
# isto dividindo uma porção de cartas em 2 e depois mesclando as duas porções.
# Por exemplo:
...
# naquele instante. Considere que todo estudante que entrou, saiu da
# biblioteca.
...
# número de servidores que se comunicam. Os servidores estão representados
# como um array bidimensional onde o valor 1 representa um computador e 0 a
# ausência do mesmo. Dois servidores se comunicam se eles estão na mesma linha
# ou mesma coluna.
