...
# tem. Podemos fazer isso criando uma hash que mapeia a letra para a
# quantidade. Vamos chamar essa hash de alfabeto .
...
# equipe, tem score 2. Escreva um método que calcule o score de uma
# determinada pessoa.
...
# estrutura subordinates ; a própria classe vai cuidar de montar essa
...
# depois em 6, eu posso ir descendo na cadeia até achar um lugar que ela
# caiba, olhando em "profundidade": olho 4, depois 5, se 5 estivesse cheio,
# olho a 7.
...
# A gente tem uma estrutura que nos diz quem é subordinado a quem, mas não
# temos um jeito imediato de consultar quem é chefe de quem. Então uma
# possível solução é, a cada inserção, manter o controle da chefia imediata
# daquela pessoa. Na solução proposta abaixo, adicionamos a hash imediate_boss,
# que é atualizada antes de realmente tentarmos alocar a pessoa. A função
# add_person foi renomeada para fit_person e agora atualizada o score de cada
# boss que tentamos encaixar a nova contratada.
# Como os scores são atualizados na medida em que fazemos as inserções, a
# função get_score agora precisa apenas fazer uma consulta simples à estrutura
# scores.
