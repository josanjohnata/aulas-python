...
# Exercício 4: O código abaixo está em JavaScript. Calcule sua ordem de
# complexidade para um array de tamanho n.
...
# Exercício 5: Utilize o módulo random da linguagem Python para gerar um array
# com 100 números. Cada um desses números deve ser a média de dez números
# gerados aleatóriamente. Qual é a ordem de complexidade de tempo e de espaço
# deste programa?
...
# o código abaixo para o melhor caso, pior caso e caso médio. Faça a analise de
